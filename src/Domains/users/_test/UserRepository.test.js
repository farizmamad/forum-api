...
describe('UserRepository interface', () => {
  it('should throw error when invoke abstract behavior', async () => {
    ...
    await expect(userRepository.findIdByUsername('')).rejects.toThrowError('USER_REPOSITORY.METHOD_NOT_IMPLEMENTED');
    await expect(userRepository.findUsernameById('')).rejects.toThrowError('USER_REPOSITORY.METHOD_NOT_IMPLEMENTED');
  });
});
